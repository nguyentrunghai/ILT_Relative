...
def augmented_energy_matrix_for_holo_marginal_weights( u_kln, N_k,
    ...
    (receptor_pot_energies + bpmfs).reshape(K, N)
...
def extract_complex_receptor_ligand_crds(yank_nc_files, complex_prmtop_file, receptor_prmtop_file, ligand_prmtop_file):
    """
