...
from _relative_estimators import relative_bfe_with_cv_using_exp_mean_method_4b
...
# method is either 2a, 2b, 3a, 3b, 4a, 4b
...
if args.method == "2a":
    ...
    print("Method 4b")
    relative_bfe_with_cv_using_exp_mean = relative_bfe_with_cv_using_exp_mean_method_4b
